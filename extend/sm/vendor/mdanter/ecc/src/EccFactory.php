...
class EccFactory
{
     ...
     * @return NistCurve
     */
    public static function getNistCurves($adapter = null)
    {
     ...
     * @return SecgCurve
     */
    public static function getSecgCurves($adapter = null)
    {
     ...
     */
    public static function createCurve($bitSize, $prime, $a, $b, $adapter = null)
    {
     ...
     * @return Signer
     */
    public static function getSigner($adapter = null)
    {
