...
class RandomGeneratorFactory
{
     ...
     * @return DebugDecorator|RandomNumberGeneratorInterface
     */
    public static function getHmacRandomGenerator(PrivateKeyInterface $privateKey, \GMP $messageHash, string $algorithm,$debug = false)
    {
        return self::wrapAdapter(
     ...
     * @return DebugDecorator|RandomNumberGeneratorInterface
     */
    private static function wrapAdapter(RandomNumberGeneratorInterface $generator, string $name,$debug = false)
    {
        if ($debug === true) {
