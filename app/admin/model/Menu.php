        ...
        if (!$menus) {
            ...
            foreach ($list_menu as $key => &$menu) {
                ...
                if ($menu['url_value'] != '' && ($menu['url_type'] == 'module_admin' || $menu['url_type'] == 'module_home')) {
                    ...
                    $menu['action']     = $url[2];
                    $menu['url_value']  = $menu['url_type'] == 'module_admin' ? admin_url($menu['url_value'], $menu['params']) : home_url($menu['url_value'], $menu['params'])->__toString();
                }
                $menus[$key] = $menu;
                $i++;
            }
        ...
        if (!$menus) {
            ...
            foreach ($menus as $key => &$menu) {
                ...
                if ($menu['url_value'] != '' && ($menu['url_type'] == 'module_admin' || $menu['url_type'] == 'module_home')) {
                	...
                	$menu['params'] = $params;
                    $menu['url_value'] = $menu['url_type'] == 'module_admin' ? admin_url($menu['url_value'], $params) : home_url($menu['url_value'], $params)->__toString();
                }
            }
