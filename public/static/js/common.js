    ...
    var pageLoader = function ($mode) {
        ...
        if ($mode === 'show') {
            if ($loadingEl.length) {
                ...
                jQuery('body').prepend(`<div class="bg-opacity-10 bg-white w-fit fixed" id="loading">
  <div class="bg-black bg-opacity-60 p-2.5 top-2/4 left-2/4 rounded-md text-white fixed z-50 -ml-12 -mt-6">
